...
const EditDepartment = () => {
  ...
  const [selecteDepartment, setselecteDepartment] = useState(null);
  ...
  function getPagedData() {
    ...
    else if (selecteDepartment && selecteDepartment._id)
      filtered = allDepartments.filter(
        (d) => d.department._id === selecteDepartment._id
      );
